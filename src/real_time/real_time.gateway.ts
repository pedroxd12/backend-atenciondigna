  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  /**
   * Los clientes (dashboard / app mobile) se unen a una sala
   * identificada por caseId para recibir sólo sus respuestas.
   *
  ...
  /**
   * Emite una respuesta a todos los clientes suscritos al caso.
   * Llamado internamente por el controller cuando llega el webhook de FastAPI.
   */
