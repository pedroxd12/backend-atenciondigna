...
import type { RegisterVisitDto, StudyRequestDto } from '../dto/register-visit.dto';
...
export const DEPENDENCY_RULES: DependencyRule[] = [
	...
	},
	{
		...
		condition: (visit) =>
			visit.studies.some((s) => s.type === StudyType.TOMOGRAPHY && s.usesContrast),
	},
	{
		first: StudyType.DENSITOMETRY,
		then: StudyType.MRI,
		reason: 'Solo si el estudio de imagen usa contraste.',
		condition: (visit) => visit.studies.some((s) => s.type === StudyType.MRI && s.usesContrast),
	},
	{
